export const projectsData = [

  {
    ...
    filter: ["Graphic Design", "Development"],
    tag: "Design system"
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: [
      ...
      `My primary role also gave me the ability to influence the strategy for our design system and other large-scale projects. I identified opportunities to shift left, and encouraged my team to lead by example. We defined accessibility as one of the foundations of our design system. And we publicly documented our position and approach, along with a wealth of resources to help others on their learning journey. We use automated tooling and conduct user testing with people with disabilities to validate our work, and we prioritize stories to address the findings. Our design system accessibility scores exceed industry benchmarks, and our corporate website is improving. Our Lighthouse accessibility scores increased by 20% and our WebAIM Million ranking increased by >501K, landing Boston Scientific in the top 25% and surpassing our competitors.`,
      `Training was, and remains, a crucial step in our path forward and, ultimately, our success. I identified the opportunity to reduce wasteful spend on redundant tooling and repurpose the budget on a pilot training program. I evaluated partners, selected instructor-led trainings, and defined cohorts and role-based learning paths for self-paced online training. Out of 860 invitees, 156 people attended the instructor-led courses. And, while we saw an average score of 97% for self-paced training, only 24% of people who were given licenses completed the training. These metrics validated that we need support from senior leadership to successfully roll out training at scale.`,
  ...
  },
  {
    ...
    description: [
      ...
      `I also designed the Wellness Check Services brand identity, developed the brand guidelines, and designed signage and a set of icons.`,
    ],
...

  {
    ...
    featuredImage: "/images/love-is-brewing/00.jpg",
    images: [
      "/images/love-is-brewing/01.jpg",
      "/images/love-is-brewing/02.jpg"
    ],
  ...
  },
  {
    ...
    stack: "Illustrator",
    featuredImage: "/images/yaas/00.jpg",
    images: [
      "/images/yaas/01.jpg",
      "/images/yaas/02.jpg",
      "/images/yaas/03.jpg",
  ...
  },
  {
    ...
    stack: "Illustrator, InDesign",
    featuredImage: "/images/september/00.jpg",
    images: [
  ...
  },
  {
    ...
    stack: "Airport Black metal type, PANTONE® ink, Vandercook No. 4 proof press, Challenge 265 manual guillotine paper cutter",
    featuredImage: "/images/ffs/00.jpg",
    images: [
      "/images/ffs/01.jpg",
      "/images/ffs/02.jpg"
    ],
    filter: ["Graphic Design", "Art"],
    tag: `Design`
  },
  ...
  },
  {
    ...
    description: [
      `I designed invitations, thank you cards, and return address labels for Raelan's dinosaur birthday party.`,
    ],
    stack: "Illustrator, InDesign",
  ...
  },
  {
    ...
    lead: `Invitations, thank you cards, and return address labels`,
    description: [
      `I designed invitations, thank you cards, and return address labels for Sarah's Ninja Turtles birthday party.`,
    ],
    stack: "Illustrator, InDesign",
  ...
  },
  {
    ...
    description: [
      `I designed invitations, thank you cards, return address labels, and a milestone poster for Sarah's Winter ONEderland birthday party.`,
    ],
  ...
  },
  {
    ...
    images: [
      ...
      "/images/holiday-cards/07.jpg",
      "/images/holiday-cards/08.jpg",
  ...
  },
  {
    ...
    description: [
      ...
      `Since technology connects and empowers people, I designed a simple, primarily typographic treatment reminiscent of an HTML tag. In addition to the logo, I created a style guide for the WIT brand, flyers, postcards, thank you cards (featuring an intentionally infinite loop), newsletters, signage, swag, and various other event materials.`,
    ],

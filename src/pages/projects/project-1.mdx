...
imageSrc: "src/images/anatomy/00.jpg"
...
<Image src={anatomy} class="image my-4" alt="test" />
...
<Image src={audit} class="image my-4" alt="test" />
...
<Image src={react} class="image my-4" alt="test"/>
...
<Image src={foundations} class="image my-4" alt="test"/>
...
<Image src={mvp} class="image my-4" alt="test"/>
...
<Image src={aemCC} class="image my-4" alt="test"/>
...
<Image src={theming} class="image my-4" alt="test"/>
...
<Image src={architecture} class="image my-4" alt="test"/>

Today, Anatomy's offerings include: 
- 10 Figma libraries
- 5 npm packages
- Platform-agnostic design tokens with support for CSS, Sass, and JSON
- A React component library
- Two themes and two modes
- Storybook
- A custom React documentation site powered by Contentful and Netlify
- Packaged configs for ESLint, Stylelint, and Prettier
...
<Image src={banners} class="image my-4" alt="test"/>
...
<Image src={intake} class="image my-4" alt="test"/>
...
<Image src={brainstorm} class="image my-4" alt="test" />
...
<Image src={value} class="image my-4" alt="test" />

<Image src={analytics} class="image my-4" alt="test" />

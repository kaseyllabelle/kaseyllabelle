...
imageSrc: "src/images/accessibility/00.jpg"
...
<Image src={program} class="image my-4" alt="test"/>
...
<Image src={training} class="image my-4" alt="test" />
...
<Image src={gaad} class="image my-4" alt="test" />
...
<Image src={shiftingLeft} class="image my-4" alt="test" />
...
<Image src={testing} class="image my-4" alt="test" />
...
<Image src={tableau} class="image my-4" alt="test" />
...
<Image src={progress} class="image my-4" alt="test" />
...
<Image src={impact} class="image mt-4" alt="test"/>
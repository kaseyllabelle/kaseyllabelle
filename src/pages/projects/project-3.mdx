...
imageSrc: "src/images/daily-wellness-check/00.jpg"
imageAlt: "Wellness Check Services logo"
...
<Image src={overview} class="image mt-4" alt="test" />
...
<Image src={discovery} class="image mt-4" alt="test" />
...
<Image src={flow} class="image mt-4" alt="test"/>
...
<Image src={r1} class="image mt-4" alt="test"/>
...
<Image src={r2} class="image mt-4" alt="test"/>
...
<Image src={logoWIP} class="image mt-4" alt="test"/>
...
<Image src={logo} class="image mt-4" alt="test"/>
...
<Image src={r3} class="image mt-4" alt="test"/>
...
<Image src={r4} class="image mt-4" alt="test" />
...
<Image src={dwc} class="image mt-4" alt="test"/>
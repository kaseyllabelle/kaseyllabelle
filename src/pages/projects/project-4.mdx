...
imageSrc: "src/images/blueprint/00.jpg"
...
<Image src={overview} class="image my-4" alt="test" />
...
I worked on building the Blueprint component library and its documentation website from the group up. I also worked across the PeopleCloud product suite to bridge the gap between UX and engineering.
...
<Image src={loyaltyLegacy} class="image my-4" alt="test" />
...
<Image src={tech} class="image my-4" alt="test" />
...
<Image src={codeStandards} class="image my-4" alt="test" />
...
<Image src={loyaltyCustomers} class="image my-4" alt="test" />
...
<Image src={table} class="image my-4" alt="test" />
<Image src={loyaltyDashboard} class="image mt-4" alt="test" />
